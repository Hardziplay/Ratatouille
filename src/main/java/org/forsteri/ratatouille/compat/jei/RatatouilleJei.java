...
public class RatatouilleJei implements IModPlugin {
    ...
    private class CategoryBuilder<T extends Recipe<? extends RecipeInput>> {
        ...
        public CreateRecipeCategory<T> build(String name, CreateRecipeCategory.Factory<T> factory) {
            ...
            CreateRecipeCategory.Info<T> info = new CreateRecipeCategory.Info(new mezz.jei.api.recipe.RecipeType(Ratatouille.asResource(name), this.recipeClass), Lang.translateDirect("recipe." + name, new Object[0]), this.background, this.icon, recipesSupplier, this.catalysts);
