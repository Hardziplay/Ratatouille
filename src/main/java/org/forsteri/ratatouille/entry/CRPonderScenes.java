...
import org.forsteri.ratatouille.ponder.SpreaderBreedScene;
...
public class CRPonderScenes {
    ...
    public static void register(PonderSceneRegistrationHelper<ResourceLocation> helper) {
        ...
        HELPER.addStoryBoard(CRBlocks.SPREADER_BLOCK, "spreader_breed", SpreaderBreedScene::spreader_breed, new ResourceLocation[0]);
