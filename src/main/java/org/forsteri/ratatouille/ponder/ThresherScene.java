...
public class ThresherScene {
    public ThresherScene() {
    }

    public static void thresher(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world().modifyEntity(resultItem, (e) -> {e.remove(RemovalReason.KILLED);});
        ...
        scene.idle(10);
        scene.world().modifyEntity(itemLink, (e) -> {e.remove(RemovalReason.KILLED);});
