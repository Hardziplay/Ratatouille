...
public class SpreaderInstance extends KineticBlockEntityInstance<SpreaderBlockEntity> {
    protected final RotatingData shaft;
    protected final RotatingData fan;
    final Direction direction;
    private final Direction opposite;

    public SpreaderInstance(MaterialManager materialManager, SpreaderBlockEntity blockEntity) {
