...
public class SpreaderRenderer extends KineticBlockEntityRenderer<SpreaderBlockEntity> {
    public SpreaderRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }
